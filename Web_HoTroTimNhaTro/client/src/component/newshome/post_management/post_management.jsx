...
class Postmanagement extends Component {
  ...
  async componentDidMount() {
    await axios
      .get("/phong-tro/quan-ly-tin-dang/phong-tro")
      .then((res) => {
        this.setState({
  ...
  ClickHiddenNews = async (e) => {
    ...
    await axios
      .post(
        "/phong-tro/quan-ly-tin-dang/an-tin-tuc-phong-tro",
        {
          id,
        },
            ...
            <tbody>
              {this.state.list_PT.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>
                    {item.infor.state_news === true ? (
                      <button
                        className="bnt-click_hidden_news"
                        value={item._id}
                        onClick={(e) => this.ClickHiddenNews(e)}
                      >
                        Tin đang hiện
                      </button>
                    ) : (
