        ...
        <div className="row">
            ...
            <div className=" row profile-sidebar">
              <div className="col-md-4 col-sm-4 profile_imgavatar">
                <div className="profile-userpic">
                  <img
                    src={
                      this.state.img_avatar
                        ? this.state.img_avatar
                        : "https://static123.com/uploads/images/2018/12/12/boy_1544603222.png"
                    }
              ...
              <div className="col-md-8 col-sm-8 profile-infor">
                ...
                {this.state.role === "CHUNHATRO" && (
                  <p className="profile-infor-numberphone">
                    {this.state.number_phone
                      ? "0" + this.state.number_phone
                      : " "}
                  </p>
                )}
              </div>
                ...
                <ul className="nav navbar-nav navbar_mg-ul">
                    ...
                    <div>
                      ...
                      <li className="nav-link post_manager-memu">
                        ...
                        <ul className="post_manager-memu-ul">
                          <li className="nav-item nav_menu_mg">
                            <Link
                              to="/nguoi-dung/quan-ly-tin-dang/phong-tro"
                              className="nav-link nav_menu_mg "
                            >
                              Quản lý tin phòng trọ
                            </Link>
                          </li>
                          <li className="nav-item nav_menu_mg">
                            <Link
                              to="/nguoi-dung/quan-ly-tin-dang/nha-tro"
                              className="nav-link nav_menu_mg "
                            >
                              Quản lý tin nhà trọ
                            </Link>
                          ...
                          <li className="nav-item nav_menu_mg">
                            <Link
                              to="/nguoi-dung/quan-ly-tin-dang/can-ho"
                              className="nav-link nav_menu_mg "
                            >
                              Quản lý tin căn hộ
                            </Link>
                  ...
                  <li className="nav-item nav_menu_mg">
                    <Link
                      className="nav-link nav_menu_mg"
                      to="/doi-mat-khau"
                      onClick={this.OpenModalChangePasswordtoHomeNews}
                    >
                      {" "}
                      Đổi mật khẩu
                    </Link>
                  ...
                  <li className="nav-item nav_menu_mg">
                    <Link
                      ...
                      to=""
                      id="ClickGoHome"
                      onClick={this.ClickGoHometoHomeNews}
                    >
                      Về trang chủ
                    </Link>
                  </li>
                  <li
                    className="nav-link nav_menu_mg"
                    onClick={this.ClickLogouttoHome}
                  >
                    Đăng xuất
                  </li>
                  {/* Li ao */}
                  <li
                    className="nav-link nav_menu_mg hidden-change-password"
          ...
          <div className="col-md-10 col-sm-10 wapper">
            <Switch>
              <Route
                exact
                path="/nguoi-dung/sua-thong-tin"
                component={Inforuser}
              />

              <Route
                exact
                path="/nguoi-dung/dang-tin-moi"
                render={(props) => (
                  <Newsnew
                    {...props}
                    GetPhone_Number={this.state.number_phone}
                  />
                )}
              />
              <Route
                exact
                path="/nguoi-dung/quan-ly-tin-dang/phong-tro"
              ...
              <Route
                exact
                path="/nguoi-dung/quan-ly-tin-dang/nha-tro"
                component={PostmanagementNT}
              />
              <Route
                exact
                path="/nguoi-dung/quan-ly-tin-dang/can-ho"
                component={PostmanagementCH}
              />
            </Switch>
            <ChangePassword />
          </div>
