...
class VerifyPhoneNumber extends Component {
  ...
  Click_send_otp = (e) => {
    ...
    if (this.state.number_phone.length < 10) {
      ...
      axios
        .post(
          "/nguoi-dung/xac-thuc/so-dien-thoai",
          {
            number_phone_post,
          },
  ...
  Click_key_Otp = () => {
    ...
    axios
      .post(
        "/nguoi-dung/xac-thuc/so-dien-thoai/ma-OTP",
        {
          number_phone,
          key_OTP,
        },
          ...
          <div className="modal-content">
            <div className="modal-header text-center">
              ...
              >
                <span
                  aria-hidden="true"
                  onClick={this.handleClickClosePhone_NB}
                >
                  ×
                </span>
              </button>
            ...
            <div className="modal-body mx-3">
              {this.state.error_message.length > 0 && (
                <p className="error_message-login">
              ...
              <div className="row row_form_phone_nb ">
                ...
                <div className=" col-md-3 col-sm-4 col-xs-4 bnt_form_phone_nb">
                  <input
                    type="button"
                    value="Gửi OTP"
                    onClick={(e) => this.Click_send_otp(e)}
                    disabled={this.state.disabled_input_phone_NB}
                  />
                </div>
              </div>
